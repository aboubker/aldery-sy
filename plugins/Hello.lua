...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "❤️ آهلآَ وسَهلآَ نورت كروبك"..nama.."\n🌹 نَـورتَ الكروب 👥 '"..string.gsub(msg.to.print_name, "_", " ").."'\n🌹 يرجى اتباع القوانين لتجنب الطرد 😉 \n"
      local text = sambutan.."لروئية قوانين المجموعة /أرسل / القوانين 🙏🏿      "
      local text = text..""
      local text = text.."                                               "
      local text = text.."للخروج من المجموعة /مغادره ☹️"
      local text = text..""
      local text = text.."                                               "
      local text = text.."تابعو قناة المطور ليصلكم كل جديد]"
      local text = text..""
      local text = text.."                                               "
      local text = text.."@antrohi @sy051 \n☝🏿️"
      local receiver = get_receiver(msg)
